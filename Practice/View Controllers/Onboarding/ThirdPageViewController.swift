...
class ThirdPageViewController: UIViewController {
    ...
    @IBOutlet var colorfulLabel: UILabel!
    ...
    func makeColorfulLabel() {
        colorfulString = NSMutableAttributedString(string: labelText as String,
                                                   attributes: [
                                                    NSAttributedString.Key.font: UIFont(
                                                        name: "Open Sans",
                                                        size: 16.0) ?? UIFont.systemFont(ofSize: 16)])
        colorfulString.addAttribute(NSAttributedString.Key.foregroundColor,
                                    value: UIColor.onboardingYellow.self,
